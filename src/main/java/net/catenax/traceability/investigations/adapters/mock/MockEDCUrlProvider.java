...
public class MockEDCUrlProvider implements EDCUrlProvider {
	...
	private static final Map<String, String> bpnMapping = Map.of(
		...
		"BPNL00000003CML1", "https://tracex-consumer-controlplane.dev.demo.catena-x.net/api/v1",
		"BPNL00000003CNKC", "http://provider-controlplane:8282",
		"BPNL00000003AYRE", "https://tracex-test-consumer-controlplane.dev.demo.catena-x.net/api/v1"
	);
