...
public class MockEDCUrlProvider implements EDCUrlProvider {
	...
	private static final Map<String, String> bpnMapping = Map.of(
		...
		"BPNL00000001AXS1", "https://trace-x-edc.dev.demo.catena-x.net",
		"BPNL00000003CML1", "https://trace-x-edc.dev.demo.catena-x.net",
		"BPNL00000003CNKC", "https://trace-x-test-edc.dev.demo.catena-x.net",
