...
@Component
public class ShellDescriptorDbStore implements ShellDescriptorStore {
	private final ShellDescriptorRepository shellDescriptorRepository;

	public ShellDescriptorDbStore(ShellDescriptorRepository shellDescriptorRepository) {this.shellDescriptorRepository = shellDescriptorRepository;}
